...
void dibujarEscenarioRes2(Imagen *piso, Imagen *arbol);
void dibujarPato(Imagen *patoImg, Pato *pato);
void vueloPato(Pato *pato);
void dispararPato(Pato *pato);
...
int main()
{
    ...
    while (tecla != TECLAS.ESCAPE)
    {
        ...
        if (ventana.anchoVentana() == 1920)
        {
            dibujarEscenarioRes2(pisoImg, arbolImg);
        }
